"""
KRIYO Grounded RAG Engine — Evidence Gate & Answerability Calculator
Enforces strict evidence gating (Phase 14) and future prediction abstention (Phase 18).
"""
...
class AnswerabilityGate:
    ...
    def evaluate_answerability(self, retrieval_output: dict) -> dict:
        """
        Evaluates whether the query can be answered reliably based on retrieved evidence.
        Strictly abstains on future/prediction queries (2030, 2035, export projection).
        """
        ...
        # 1. Unanswerable intent (Out of domain or private personal data / ungrounded projections)
        ...
        # Estimate evidence coverage based on keyword query matches in retrieved text
